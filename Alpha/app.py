...
def predict_phishing():
    if request.method == 'POST':
        ...
        try:
            ...
            if social_result == 0:
                social_status = "The URL is a social media link and it is safe."
            elif social_result == 1:
                social_status = "The URL is a social media link but it is not safe."
            else:
                social_status = "The URL is NOT a social media link."
